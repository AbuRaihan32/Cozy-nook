...
const AgentCard = ({ agent }) => {
    ...
    return (
        <div style={{backgroundImage: 'url(https://i.ibb.co/FHVd8f9/pexels-tom-mal-k-2581922.jpg)'}} className='bg-cover rounded-2xl'>
            <div className="flex flex-col justify-center max-w-xs p-6 py-10 shadow-md rounded-2xl sm:px-12 bg-black bg-opacity-60 text-gray-100">
                <img src={agent_image} alt="" className="w-32 h-32 mx-auto rounded-full bg-gray-500 aspect-square" />
                <div className="space-y-4 text-center divide-y divide-gray-700">
                    <div className="my-2 space-y-1">
                        <h2 className="text-xl font-semibold sm:text-2xl">{agent_name}</h2>
                        <p className="px-5 text-xs sm:text-base text-gray-400">{agent_phone}</p>
                    </div>
