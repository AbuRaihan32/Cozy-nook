...
const Footer = () => {
    return (
        <footer style={{ backgroundImage: 'url(https://i.ibb.co/DtDBNfN/pexels-vecislavas-popa-1571463.jpg)' }} className="rounded-t-3xl divide-y mt-20 bg-center bg-cover bg-no-repeat text-white ">
            <div className="bg-black bg-opacity-70 px-10 pt-12 pb-7 rounded-t-3xl">
                <div className="flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3 text-center">
                        ...
                        <p>The Best Way To Find <br /> Your Dream Home</p>
                    </div>
